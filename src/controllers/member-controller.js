...
async function createMember(req, res, next) {
  ...
  let alreadyExistMembership
  if (body.membershipId) {
    alreadyExistMembership = await memberLogics.getMemberByMembershipId(body.membershipId)
  }
  // console.log(alreadyExistMembership, alreadyExistEmail)
  if (alreadyExistEmail.length > 0 || (body.membershipId && alreadyExistMembership.length > 0)) {
